...
export default class ShuffleText {
  ...
  public sourceRandomCharacter: string =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890abcdefghijklmnopqrstuvwxyz1234567890=~{}()@!#$%^&*-+_"
   ...
   * @default '-'
   */
  public sourceEmptyCharacter: string = "-"
  ...
  public start(): void {
    ...
    for (let i = 0; i < this._originalLength; i++) {
      ...
      str += this.emptyCharacter.charAt(Math.floor(Math.random() * this.emptyCharacter.length))
    }
